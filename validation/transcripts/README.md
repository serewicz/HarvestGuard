...
| Transcript | Run |
| --- | --- |
| `2026-08-18-almalinux-9.8-phase1.txt` | AlmaLinux 9.8, complete eight-gate run ([report](../reports/2026-08-18-almalinux-9.8-phase1.md)) |
| `2026-08-18-almalinux-9.8-phase1-halted-run.txt` | AlmaLinux 9.8, earlier run halted inside stage 7 by the pandas 3.x defect described in the same report |
