...
| Evidence digest | c48aeb76924fe920bea0e5fea125cdff7018d5712a54f2c91837968620a7d0db |
| Retained snapshot occurrences | 1 |

**Evidence evaluation: FAILED**

> Evidence evaluation: FAILED. At least one required check completed and failed for the declared scope. Individual passed checks and retained evidence are still listed; they do not offset the failed check.

Why this evaluation:

- EV\-RSN\-001: 1 required check\(s\) completed and failed: EV\-CHK\-005 reference\_consistency.
...
| EV\-CHK\-005 | reference\_consistency | yes | yes | failed |
...
- State: passed
- Result: The stored run's recomputed digest matched the stored digest c48aeb76924fe920bea0e5fea125cdff7018d5712a54f2c91837968620a7d0db.
...
- State: failed
- Result: 1 stored reference inconsistency\(ies\) were found: snapshot synthetic\-failed\-001\#0 records scan\_id synthetic\-some\-other\-run.
...
- Evidence: [synthetic\-failed\-001 ordinal 0 (finding ID 2adf7d326cca9a250b6785c912057fa2c6ac9421caf7ff54d791e9b3e137086f)](#evidence-synthetic-failed-001-0)
...
- Statement: The stored run's recomputed digest matched the stored digest c48aeb76924fe920bea0e5fea125cdff7018d5712a54f2c91837968620a7d0db.
- Method: evidence\_store.load\_scan\_run\(\) recomputed the stored run's SHA\-256 digest over its canonical run payload and ordered finding snapshots and compared it with the stored digest. verify\_loaded\_scan\_run\(\) rechecked the current payload with the same canonical digest definition and checked reconstruction consistency before this projection was built. A mismatch fails closed with EvidenceIntegrityError; no view is produced.
...
<a id="evidence-synthetic-failed-001-0"></a>

### Occurrence 0

- Complete reference: scan synthetic\-failed\-001, ordinal 0, finding ID 2adf7d326cca9a250b6785c912057fa2c6ac9421caf7ff54d791e9b3e137086f

| Stored field | Value |
| --- | --- |
| finding\_id | 2adf7d326cca9a250b6785c912057fa2c6ac9421caf7ff54d791e9b3e137086f |
| scan\_id | synthetic\-some\-other\-run |
